  ...
  render: function() {
    return(
      <figure className="contact-row">
        ...
        <div className="col-xs-3 hidden-xs"><i className="pull-right mdi mdi-delete account2" onClick={this.props.deleteContact.bind(null,this.props.i)} style={{marginLeft:20,backgroundColor:'crimson',cursor:'pointer'}}></i><i className="pull-right fa fa-edit account2"></i></div>
      </figure>
    );
  }
});
